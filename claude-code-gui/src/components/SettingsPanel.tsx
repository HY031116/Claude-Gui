  ...
  return (
    <div style={{ padding: 12 }}>
      ...
      <div style={{ marginBottom: 16 }}>
        ...
        {(
          [
            { key: 'permissionAllow' as const, label: '允许 (allow)', placeholder: '例：Bash(git *) 或 Read' },
            { key: 'permissionDeny'  as const, label: '拒绝 (deny)',  placeholder: '例：Read(.env) 或 Bash(rm:*)' },
      ...
      <div style={{ marginBottom: 16 }}>
        ...
        <div style={{ fontSize: 11, color: 'var(--text-muted)', marginTop: 4, marginLeft: 20 }}>
          开启时 Claude 会读写 CLAUDE.md 记忆文件；关闭时跳过记忆目录
        </div>
      </div>
